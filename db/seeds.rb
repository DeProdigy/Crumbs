...
Post.create(user_id: user2.id, title: 'MTA', image_url: 'http://i.huffpost.com/gen/353321/MTA-MAP.jpg', latitude: '40.7178064', longitude: '-73.9576661')
Post.create(user_id: user2.id, title: 'El Cribo', image_url: 'http://www.cpsc.gov/PageFiles/78256/08314a.jpg', latitude: '40.6040581', longitude: '-73.9584267')
Post.create(user_id: user2.id, title: 'Coffee', image_url: 'http://www.businessgreen.com/IMG/846/219846/coffee-cup.jpg', latitude: '40.6418153', longitude: '-73.9633948')
